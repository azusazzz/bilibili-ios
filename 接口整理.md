...
`可用接口` http://space.bilibili.com/893053/#!/index `实在不行了，可以用这个`

https://account.bilibili.com/api/member/getCardByMid?mid=893053 `用户基本信息`

http://elec.bilibili.com/api/query.rank.do?mid=893053&pay_mid=2610184&type=json `充电`(接口有点问题，注意转一下utf8)


http://space.bilibili.com/api/member/getSettings?build=3710&device=phone&mid=893053&mobi_app=iphone&platform=ios `好像是用户的一些观看信息`
